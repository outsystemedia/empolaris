      ...
      <div className="grid grid-cols-2">
        ...
        <div className="order-2 md:order-3 col-span-full md:col-span-1 py-5 md:py-10 px-6">
          <div className="mx-auto max-w-xl flex flex-col space-y-5">
            ...
            {/* ::Address */}
            <p className="text-sm text-gray-500 leading-6">Rua Periquito, 331<br />Bombas, Bombinhas/SC<br />88215-000</p>
            {/* ::Socials */}
            <div className="flex items-center">
              {/* :FACEBOOK */}
              <a href="https://www.facebook.com/polaris.emp" className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-[#4267B2] text-white filter hover:brightness-125" style={{ backgroundColor: "#4267B2" }}>
                {/* ::facebook svg */}
              ...
              {/* :Instagram */}
              <a href="https://www.instagram.com/polaris.empreendimentos/" className="m-1.5 w-8 h-8 inline-flex justify-center items-center shadow-sm rounded-full bg-gradient-to-tr from-yellow-400 via-red-500 to-purple-500 text-white filter hover:brightness-125">
                {/* ::instagram svg */}
